...
! function(e, t) {
	...
	e.extend(!0, O, {
		...
		type: {
			...
			integer: "Este valor debe ser un nÃºmero entero vÃ¡lido.",
			digits: "Este valor debe ser dÃ­gitos.",
			alphanum: "Este valor debe ser alfanumÃ©rico. "
		},
		notblank: "Este valor no debe estar en blanco.",
		required: "Este valor es obligatorio.",
		pattern: "Este valor parece no ser vÃ¡lido.",
		min: "Este campo debe contener almenos %s caracteres.",
		max: "Este valor debe ser menor o igual que %s.",
		range: "Este valor debe estar entre %s y %s.",
		minlength: "Este valor es demasiado corto. Debe tener %s caracteres o mÃ¡s.",
		maxlength: "Este valor es demasiado largo. Debe tener %s caracteres o menos.",
		length: "La longitud de este valor no es vÃ¡lida. Debe tener entre %s y %s caracteres.",
		mincheck: "Debe seleccionar al menos %s opciones.",
		maxcheck: "Debe seleccionar %s opciones o menos.",
		check: "Debe seleccionar entre las opciones %s y %s.",
		equalto: "Los valores deberÃ­an ser identicos."
	}), O.setLocale("en");
	var D = new n;
	D.install();
	var I = O;
